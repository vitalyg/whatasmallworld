	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: 'progress/images/progressbar.gif',			// boxImage : image around the progress bar
				barImage		: {
									0:	'progress/images/progressbg_red.gif',
									30: 'progress/images/progressbg_orange.gif',
									70: 'progress/images/progressbg_green.gif'
								},
